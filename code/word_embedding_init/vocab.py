'''
This code is modified by Peng Ying from Kuang-Huei Lee's repository.
...
annotations = {
    #'kdd2020_caps':['train_caps.txt','valid_caps.txt','train.sample_caps.txt']
    'kdd2020_caps':['train_caps.txt','valid_caps.txt']
    #'kdd2020_caps':['train_caps.txt']
}
